...
# run 
qemu-system-i386 -cpu host -m 256M -vga std -hda 'disks/disk01.img' -cdrom 'AerOS.iso' -name 'AerOS Development Copy' -serial stdio -boot d -rtc base=$(date +"%y-%m-%dT-%r") -soundhw all -device e1000 -enable-kvm
fi