...
i686-elf-g++ -Iinclude -c 'src/hardware/drivers/pci.cpp' -o 'bin/objs/pci.o' -ffreestanding -O2 -Wall -Wextra -fno-exceptions -fno-rtti -Wno-write-strings -Wno-unused-variable
